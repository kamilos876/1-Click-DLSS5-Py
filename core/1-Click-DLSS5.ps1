<#
.SYNOPSIS
    1 Click DLSS 5 v2.5.0 • Universal Neural Control Center
...
$form.Text = "1 Click DLSS 5 v2.5.0 • Universal Neural Control Center"
...
# Inicialização
Write-Status -Message "1 Click DLSS 5 v2.5.0 pronto e operacional." -Level "OK"
