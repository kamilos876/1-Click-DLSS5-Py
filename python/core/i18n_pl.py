...
PL = {
    ...
    "Footer": "1 Click DLSS 5 v2.6.0 | Uniwersalny Feeder 2.0 (wszystkie gry PC) | RTX 20/30/40/50 | DX11 / DX12 / Vulkan / OpenGL",
    "Badge100": "✓ W 100% ZGODNA (natywny DLSS)",
    "Badge100Short": "✓ Natywny DLSS",
    "BadgeDX12": "✓ ZGODNA (DirectX 12)",
    "BadgeDX12Short": "✓ DirectX 12",
    "BadgeBridge": "✓ ZGODNA PRZEZ OPTISCALER (FSR2/XeSS → DLSS 5)",
    "BadgeBridgeShort": "✓ Mostek OptiScaler",
    "BadgeFeeder": "✓ UNIWERSALNA (Feeder DLSS 5 • 100% natywne DLAA)",
    "BadgeFeederShort": "✓ Uniwersalny Feeder",
    ...
    "BadgeMissingShort": "✗ Brak folderu",
