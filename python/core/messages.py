...
EN = {
    ...
    "Not64Bit": "The selected executable must be 64-bit.",
    "NoMainExe": "No main 64-bit executable was found in this game folder.",
    # Install worker
...
PL = {
    ...
    "Not64Bit": "Wybrany plik wykonywalny musi być 64-bitowy.",
    "NoMainExe": "Nie znaleziono głównego pliku wykonywalnego 64-bit w tym folderze gry.",
...
PT = {
    ...
    "Not64Bit": "O executavel selecionado precisa ser de 64-bit.",
    "NoMainExe": "Nenhum executavel principal de 64-bit foi encontrado nesta pasta de jogo.",
