...
PT = {
    ...
    "Footer": "1 Click DLSS 5 v2.6.0 | Feeder Universal 2.0 (Qualquer Jogo de PC) | RTX 20/30/40/50 | DX11 / DX12 / Vulkan / OpenGL",
    "Badge100": "✓ 100% COMPATÍVEL (DLSS Nativo)",
    "Badge100Short": "✓ DLSS Nativo",
    "BadgeDX12": "✓ COMPATÍVEL (DirectX 12)",
    "BadgeDX12Short": "✓ DirectX 12",
    "BadgeBridge": "✓ COMPATÍVEL VIA OPTISCALER (FSR2/XeSS → DLSS 5)",
    "BadgeBridgeShort": "✓ Ponte OptiScaler",
    "BadgeFeeder": "✓ UNIVERSAL (Modo Feeder DLSS 5 • DLAA 100% Nativo)",
    "BadgeFeederShort": "✓ Feeder Universal",
    ...
    "BadgeMissingShort": "✗ Pasta ausente",
...
EN = {
    ...
    "Footer": "1 Click DLSS 5 v2.6.0 | Universal Feeder 2.0 (All PC Games) | RTX 20/30/40/50 | DX11 / DX12 / Vulkan / OpenGL",
    "Badge100": "✓ 100% COMPATIBLE (Native DLSS)",
    "Badge100Short": "✓ Native DLSS",
    "BadgeDX12": "✓ COMPATIBLE (DirectX 12)",
    "BadgeDX12Short": "✓ DirectX 12",
    "BadgeBridge": "✓ COMPATIBLE VIA OPTISCALER (FSR2/XeSS → DLSS 5)",
    "BadgeBridgeShort": "✓ OptiScaler bridge",
    "BadgeFeeder": "✓ UNIVERSAL (DLSS 5 Feeder • 100% Native DLAA)",
    "BadgeFeederShort": "✓ Universal Feeder",
    ...
    "BadgeMissingShort": "✗ Folder missing",
